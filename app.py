...
if not api_key:
    try:
        ...
        st.error("⚠️ Error: API Key not found. En Railway, ve a Variables y añade 'GEMINI_API_KEY' con tu clave.")
        st.stop()
...
# Aquí están los IDs que proporcionaste. Agent Coach AI los usará como "memoria" adicional.
